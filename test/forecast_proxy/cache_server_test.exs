defmodule ForecastProxy.CacheServerTest do
  use ForecastProxyWeb.ConnCase
  ...
  describe "server" do
    ...
    test "caching results", %{mock: body} do
      ...
      assert {:ok, body} == ForecastProxy.CacheServer.get_forecast(@cooordinates)
      ...
      assert {:ok, new_body} == ForecastProxy.CacheServer.get_forecast(@cooordinates)
    end
  end
end
